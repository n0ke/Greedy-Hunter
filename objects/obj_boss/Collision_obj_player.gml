with(other)
{
	if(cooldown_hit <= 0)
	{
		spd.x = lengthdir_x(48, point_direction(other.x,other.y,obj_player.x,obj_player.y));
		spd.y = lengthdir_y(48, point_direction(other.x,other.y,obj_player.x,obj_player.y));
		sleep(50)
		vida -= other.damage;
